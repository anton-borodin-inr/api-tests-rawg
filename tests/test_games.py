...
pytestmark = [allure.epic("RAWG API Tests"), allure.feature("Games")]
...
@pytest.mark.regression
@allure.story("Get 'results' in response")
...
@pytest.mark.regression
@allure.story("Game details schema")
@allure.severity(allure.severity_level.NORMAL)
...
@allure.story("Game lookup by id")
@allure.severity(allure.severity_level.NORMAL)
